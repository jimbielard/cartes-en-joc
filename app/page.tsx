  ...
  return <main className="min-h-screen bg-[radial-gradient(circle_at_top,_#fff7ed_0%,_#ffe4e6_35%,_#fffaf5_100%)] p-4 text-slate-800 sm:p-6"><div className="mx-auto max-w-6xl">
    <header className="mb-6 rounded-3xl border border-pink-200 bg-white p-4 sm:p-6">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="home-account grid w-full gap-3 sm:flex sm:w-auto sm:flex-wrap sm:items-center">
      ...
      <nav aria-label="Partides" className="mt-4"><Link href="/join" className="flex w-full items-center justify-center rounded-xl border border-slate-300 px-5 py-3 text-center text-sm font-semibold sm:w-fit">Entrar amb codi</Link></nav>
    </header>
    <RestaurantPicker />
